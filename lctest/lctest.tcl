# 
# Project automation script for lctest 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source lctest.tcl), then you can
...
set myProject "lctest"
set myScript "lctest.tcl"
...
proc set_project_props {} {
   ...
   project set device "xc9572xl"
   project set package "VQ44"
